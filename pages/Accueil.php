...
<body>
	<header>
		...
		<a href="../pages/Connection.php" class="login"><img src="../img/Log_In.png" alt=""></a>
	...
	<div class="container">
		<div class="contenu">
		<center><h1>Bienvenue sur GénéaLauret</h1>
		<br>
    	<h4>Le site de Généalogie de la Famille Lauret</h4></center>
		<br>
		<p>
			- Notre généalogie principalement en Aveyron, Dordogne, Lot et Garonne et Suisse...
		
			<br>
			- Quelques relevés d'état-civil en Aveyron
		</p>
		<br>
